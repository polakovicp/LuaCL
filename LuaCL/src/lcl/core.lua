...
function NewContext(p)
	...
	local GetDeviceInfo =
		function()
			local i={},e
			i["CL_DEVICE_TYPE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_TYPE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_VENDOR_ID"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_VENDOR_ID") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_COMPUTE_UNITS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_COMPUTE_UNITS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_CLOCK_FREQUENCY"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_CLOCK_FREQUENCY") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_ADDRESS_BITS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_ADDRESS_BITS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_READ_IMAGE_ARGS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_READ_IMAGE_ARGS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_WRITE_IMAGE_ARGS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_WRITE_IMAGE_ARGS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_SAMPLERS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_SAMPLERS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MEM_BASE_ADDR_ALIGN"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MEM_BASE_ADDR_ALIGN") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_CONSTANT_ARGS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_CONSTANT_ARGS") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_WORK_GROUP_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_WORK_GROUP_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE2D_MAX_WIDTH"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE2D_MAX_WIDTH") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE2D_MAX_HEIGHT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE2D_MAX_HEIGHT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE3D_MAX_WIDTH"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE3D_MAX_WIDTH") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE3D_MAX_HEIGHT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE3D_MAX_HEIGHT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE3D_MAX_DEPTH"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE3D_MAX_DEPTH") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_PARAMETER_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_PARAMETER_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PROFILING_TIMER_RESOLUTION"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PROFILING_TIMER_RESOLUTION") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_MEM_ALLOC_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_MEM_ALLOC_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_GLOBAL_MEM_CACHE_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_GLOBAL_MEM_CACHE_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_GLOBAL_MEM_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_GLOBAL_MEM_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_LOCAL_MEM_SIZE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_LOCAL_MEM_SIZE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_IMAGE_SUPPORT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_IMAGE_SUPPORT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_ERROR_CORRECTION_SUPPORT"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_ERROR_CORRECTION_SUPPORT") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_ENDIAN_LITTLE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_ENDIAN_LITTLE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_AVAILABLE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_AVAILABLE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_COMPILER_AVAILABLE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_COMPILER_AVAILABLE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_SINGLE_FP_CONFIG"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_SINGLE_FP_CONFIG") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_GLOBAL_MEM_CACHE_TYPE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_GLOBAL_MEM_CACHE_TYPE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_LOCAL_MEM_TYPE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_LOCAL_MEM_TYPE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_EXECUTION_CAPABILITIES"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_EXECUTION_CAPABILITIES") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_QUEUE_PROPERTIES"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_QUEUE_PROPERTIES") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_MAX_WORK_ITEM_SIZES"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_MAX_WORK_ITEM_SIZES") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PLATFORM"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PLATFORM") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_NAME"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_NAME") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_VENDOR"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_VENDOR") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DRIVER_VERSION"],e = cl.DeviceInfo(self.device[1], "CL_DRIVER_VERSION") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_PROFILE"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_PROFILE") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_VERSION"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_VERSION") if e ~= cl.CL_SUCCESS then return nil, e end
			i["CL_DEVICE_EXTENSIONS"],e = cl.DeviceInfo(self.device[1], "CL_DEVICE_EXTENSIONS") if e ~= cl.CL_SUCCESS then return nil, e end
			return i,e
		end
